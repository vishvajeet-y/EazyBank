...
public class CardDto {
    ...
    @Positive(message = "Total limit of card should be greater than zero")
    @Schema(
            description = "Total amount limit available against a card", example = "100000"
    )
    private Long totalLimit;
    @PositiveOrZero(message = "Total ammount used should be equal or greater than zero")
    @Schema(
            description = "Total amount used by a Customer", example = "1000"
    )
    private Long ammountUsed;
    @PositiveOrZero(message = "Total available Ammount should be equal or greater than zero")
    @Schema(
